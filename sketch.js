...
function setup() {
  ...
  leftWall = new Base(-50, height -300, 200, height / 2 + 100);
  rightWall = new Base(width +200, height - 300, 200, height / 2 + 100);

  bridge = new Bridge(18, { x: -120, y: height / 2 - 100 });
  jointPoint = new Base(width -200, height / 2 - 60, 20, 10);
...
function draw() {
  ...
  for (var stone of stones) {
    ...
    //checa la distancia entre el zombie y las piedras
